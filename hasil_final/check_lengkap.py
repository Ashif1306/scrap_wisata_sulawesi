...
# Check wisata_sulawesi_lengkap.csv (the regenerated one)
...
for idx, row in df.iterrows():
    ...
    if is_mm:
        mm += 1
        print(f"  MISMATCH: {row['nama_wisata']} | {row['kabupaten']} | {row['provinsi']}")

print(f"Total remaining mismatches in wisata_sulawesi_lengkap.csv: {mm}")
